-- ============================================================================
-- ACTUALIZAR RPCs PARA INCLUIR CAMPO SURCHARGE
-- ============================================================================
-- Descripción: Actualiza las funciones create_full_reservation y
--              update_full_reservation para manejar el campo surcharge
-- Fecha: 2025-01-10
-- ============================================================================

-- ============================================================================
-- ACTUALIZACIÓN DE create_full_reservation PARA INCLUIR SURCHARGE
-- ============================================================================
...
BEGIN
    ...
    -- Paso 2: Crear la reserva principal (INCLUYENDO SURCHARGE)
    ...
    VALUES (
        ...
        COALESCE((payload->>'surcharge')::NUMERIC, 0),  -- <<<< NUEVO CAMPO CON DEFAULT 0
    ...
    IF payload ? 'transfers' THEN
        ...
        LOOP
            ...
            BEGIN
                ...
                target_segment_id := segment_ids[target_segment_index + 1]; -- Arrays en PostgreSQL son 1-indexed
...
-- ============================================================================
-- ACTUALIZACIÓN DE update_full_reservation PARA INCLUIR SURCHARGE
-- ============================================================================
...
BEGIN
    ...
    -- Paso 2: Actualizar información del cliente
    ...
    -- Paso 3: Actualizar la reserva principal (INCLUYENDO SURCHARGE)
    ...
    SET
        ...
        surcharge = COALESCE((payload->>'surcharge')::NUMERIC, 0),  -- <<<< NUEVO CAMPO
